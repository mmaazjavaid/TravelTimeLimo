            ...
            >
                ...
                <div className="space-y-4 mb-8">
                    <div className="flex items-center">
                        ...
                        <span className="text-gray-700">Date: {stepperValues?.stepperForm?.bookingInfo?.date}</span>
                    </div>
                    <div className="flex items-center">
                        <Clock className="text-blue-500 w-5 h-5 mr-2" />
                        <span className="text-gray-700">Time: {stepperValues?.stepperForm?.bookingInfo?.time}</span>
                    </div>
                    <div className="flex items-center">
                        <MapPin className="text-blue-500 w-5 h-5 mr-2" />
                        <span className="text-gray-700">Destination: {stepperValues?.stepperForm?.bookingInfo?.to}</span>
                    </div>
                </div>
